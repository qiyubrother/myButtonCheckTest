...
namespace myButtonCheckTest
{
    ...
    public partial class myButtonCheck : UserControl
    {
        ...
        {            
            ...
            {
                bitMapOn = global::myButtonCheckTest.Properties.Resources.btncheckon1;
                bitMapOff = global::myButtonCheckTest.Properties.Resources.btncheckoff1;                
            }
            else if (checkStyle == CheckStyle.style2)
            {
                bitMapOn = global::myButtonCheckTest.Properties.Resources.btncheckon2;
                bitMapOff = global::myButtonCheckTest.Properties.Resources.btncheckoff2;                
            }
            else if (checkStyle == CheckStyle.style3)
            {
                bitMapOn = global::myButtonCheckTest.Properties.Resources.btncheckon3;
                bitMapOff = global::myButtonCheckTest.Properties.Resources.btncheckoff3;                
            }
            else if (checkStyle == CheckStyle.style4)
            {
                bitMapOn = global::myButtonCheckTest.Properties.Resources.btncheckon4;
                bitMapOff = global::myButtonCheckTest.Properties.Resources.btncheckoff4;                
            }
